...
/////-=-=-=-=-=-=-=-=-=-=-=-=-=-=-//////////-=-=-=-=-=-=-=-=-=-=-=-=-=-=-///// SENSORES /////-=-=-=-=-=-=-=-=-=-=-=-=-=-=-//////////-=-=-=-=-=-=-=-=-=-=-=-=-=-=-/////
    ...
    public String toStringSensor(int posicion, int numSensor) {
        ...
        switch (numSensor) {
            ...
            case 4:
                ...
                break;
            case 5:
                return ""+listaDeSimulaciones.get(posicion).getIDMaquina();
        }
        assert sensor != null;
    ...
    public int getSimulacionMaquinaSensor(int posicion) { return listaDeSimulaciones.get(posicion).getIDMaquina(); }
