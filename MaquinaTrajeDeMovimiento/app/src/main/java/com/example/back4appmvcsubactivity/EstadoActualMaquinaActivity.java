...
public class EstadoActualMaquinaActivity extends AppCompatActivity {
    ...
    public void onClickIrAVerSensores(View view) {
        posicionSensores = historicoDeSimulaciones.getSimulacionSensorMaquina(posicionMaquina);

        Bundle bundle = new Bundle();
        bundle.putInt("posicion", posicionSensores);
